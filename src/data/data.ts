import { EPlanetTheme } from "../types/enums/planetThemes";
import { EPlanetSizes } from "../types/enums/planetSizes";

export const PLANETS = [
  {
    name: "mercury",
    id: 1,
    theme: `${EPlanetTheme.mercury}`,
    size: `${EPlanetSizes.mercury}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/mercury/mercury.usdz",
  ...
  },
  {
    name: "venus",
    id: 2,
    theme: `${EPlanetTheme.venus}`,
    size: `${EPlanetSizes.venus}`,
    overview: {
      content:
  ...
  },
  {
    name: "earth",
    id: 3,
    theme: `${EPlanetTheme.earth}`,
    size: `${EPlanetSizes.earth}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/earth/earth.usdz",
  ...
  },
  {
    name: "mars",
    id: 4,
    theme: `${EPlanetTheme.mars}`,
    size: `${EPlanetSizes.mars}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/mars/mars.usdz",
  ...
  },
  {
    name: "jupiter",
    id: 5,
    theme: `${EPlanetTheme.jupiter}`,
    size: `${EPlanetSizes.jupiter}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/jupiter/jupiter.usdz",
  ...
  },
  {
    name: "saturn",
    id: 6,
    theme: `${EPlanetTheme.saturn}`,
    size: `${EPlanetSizes.saturn}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/saturn/saturn.usdz",
  ...
  },
  {
    name: "uranus",
    id: 7,
    theme: `${EPlanetTheme.uranus}`,
    size: `${EPlanetSizes.uranus}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/uranus/uranus.usdz",
  ...
  },
  {
    name: "neptune",
    id: 8,
    theme: `${EPlanetTheme.neptune}`,
    size: `${EPlanetSizes.neptune}`,
    overview: {
      content:
    ...
    models: {
      ...
      ios: "../assets/models/neptune/neptune.usdz",
